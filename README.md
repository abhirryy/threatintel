...
A self-updating threat intelligence dashboard: **OSINT news**, **threat actors**, and **attack surface** (exploited + newly published CVEs). It refreshes **every 5 minutes** and runs **free** on GitHub Pages with your own domain.
...
.github/workflows/update.yml   runs every 5 minutes
...
### Step 5 — Confirm the 5-minute auto-update
...
4. From now on it runs automatically every 5 minutes. Nothing else to do.
